...
import { Luv2ShopFormService } from 'src/app/services/Ecomm-form.service';
import { Country } from 'src/app/common/country';
import { State } from 'src/app/common/state';
import { EcommValidators } from 'src/app/Validators/Ecomm-validators';
      ...
      customer: this.formBuilder.group({
        firstName: new FormControl('', 
                              [Validators.required, 
                               ...
                               EcommValidators.notOnlyWhitespace]),
